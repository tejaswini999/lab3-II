...
\section{Introduction}
 ...
 Worldwide shipment of camera phones were estimated to reach 1.14 billion in the year 2011 alone [1]. Furthermore, a survey of over 2,500 respondents by Photobucket reveals that 45\% of the respondents use mobile devices to shoot video at least once weekly during the summer of 2011, validating the significant increase in the amount of mobile video uploaded to Photobucket \' s video sharing website (14 in Summer 2011 compared to December 2010) [2].
...
\includegraphics[width=4cm, height=4cm]{img6.png.png}
\subsection{Dataset}
...
\includegraphics[width=4cm, height=4cm]{img8.png}
